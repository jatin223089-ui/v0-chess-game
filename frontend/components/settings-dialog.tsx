...
export function SettingsDialog({ trigger }: SettingsDialogProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-[min(90dvh,calc(100dvh-1.5rem))] max-w-lg overflow-hidden p-0">
        <DialogHeader className="border-b border-border px-4 pb-4 pt-5 sm:px-6 sm:pb-4 sm:pt-6">
        ...
        <div className="max-h-[min(55dvh,22rem)] space-y-6 overflow-y-auto px-4 py-4 sm:max-h-[70vh] sm:px-6 sm:py-5">
          {/* Board theme picker */}
          <section>
